                ...
                RoomPlan.count(function (err, count) {
                  if (count === 0) {
                    RoomPlan.create({
                      ...
                      required_items:  ['Zug/Radfhart nach Weikersheim', 'Besuch des Deutschordensmuseum', 'Massagebehandlung im Haus', 'Eintritt in den Wildpark', 'Eintritt in den Wildpark', 'Stadtführung']
                    },{
                      ...
                      duration: 14,
                      display_string: '%duration% Tage %name% %perPerson%',
                      required_items: ['HalbpensionInc', 'Fangopackungen', 'Medizinische Sprudelbäder', 'Klassische Massage', 'Stadtführung']
                    },{
                      ...
                      pp_price: 535,
                      single_surcharge: 35,
                      single_room_price: 51.20,
                      double_room_price: 46.2, //per person
                      duration: 7,
                      display_string: '%name% %perPerson%',
                      required_items: ['HalbpensionInc', 'Kneippgüsse', 'Kräuterbad-Kneipp', 'Blitzguss-Kneipp', 'Kopfmassage-Kneipp', 'Heublumensack-Kneipp', 'Stadtführung']
                    },{
                      ...
                      duration: 7,
                      display_string: '%name% %perPerson%',
                      required_items: ['VollpensionInc', 'Stadtführung']
