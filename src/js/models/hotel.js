...
define(['./module'], function (model) {
  ...
  // Reservation schema
  model.factory('Reservation', function(db, ExpenseItem, datetime){
  ...
  model.factory('Room', function(db) {
    ...
    var roomTypeEnum = ['Economy-Einzelzimmer', 'Komfort-Einzelzimmer', 'Economy-Doppelzimmer', 'Komfort-Doppelzimmer', 'Suite-A', 'Suite-B'];
    var schema = new db.Schema({
